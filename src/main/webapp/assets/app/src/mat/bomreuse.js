    ...
    layui.use('table', function () {
        ...
        tableIns = table.render({
            ...
            , cols: [[
                ...
                , {field: 'partCount', title: '总料号', width: 120, sort: true, align: 'right'}
                , {field: 'repeatCnt', title: '复用料号', width: 120, sort: true, align: 'right'}
                , {
                    field: 'reuseRate', title: '复用率%', width: 120, sort: true, align: 'right'
