...
layui.use(['element', 'layer', 'okUtils', 'okTab', 'okLayer'], function() {
  ...
  $('body').on('keydown', function(event) {
    ...
    if (event && event.keyCode == 27) {
      ...
      $('#fullScreen')
        .children('i')
        .eq(0)
        .removeClass('okicon-screen-restore');
    }
    // 按 F11
    if (event && event.keyCode == 122) {
      $('#fullScreen')
        .children('i')
        .eq(0)
        .addClass('okicon-screen-restore');
    }
  });
  ...
  $('body').on('click', '#fullScreen', function() {
    if (
      $(this)
        .children('i')
        .hasClass('okicon-screen-restore')
    ) {
      ...
      tab: [
        {
          title: '支付宝',
          content:
            "<img src='images/zfb.jpg' width='200' height='300' style='margin-left: 60px'>"
        },
        {
          title: '微信',
          content:
            "<img src='images/wx.jpg' width='200' height='300' style='margin-left: 60px'>"
        }
      ]
    });
  });
        ...
        tab: [
          {
            title: 'QQ群',
            content:
              "<img src='images/qq.jpeg' width='200' height='300' style='margin-left: 60px'>"
          }
        ]
      });
    }
